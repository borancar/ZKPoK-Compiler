...
void coproc_execute() {
  volatile char __xdata __at(0x1200) state[1];
...
void display_result(__xdata unsigned char *val) {
	volatile char __xdata __at(0x1000) coproc_a[SIZE];
	volatile char __xdata __at(0x1180) coproc_up[SIZE];
...
void montpro(__xdata unsigned char *a, __xdata unsigned char *b, __xdata unsigned char *m, __xdata unsigned char *n) {
	volatile char __xdata __at(0x1000) coproc_a[SIZE];
	volatile char __xdata __at(0x1080) coproc_b[SIZE];
	volatile char __xdata __at(0x1100) coproc_n[SIZE];
	volatile char __xdata __at(0x1180) coproc_up[SIZE];
